const mustPlayGames = {
  Action: [
    {
      ...
      originalReleaseDate: "29/10/2009",
      introduction:
        "Bayonetta stars a witch who is capable of shapeshifting and using various firearms. She possesses magical attacks and she can use her hair to summon demons to dispatch her foes. The game features a rating system, which gives players a grade based on their performance, and a combat system that is similar to the Devil May Cry series.",
    },
  ],
  Action_RPG: [
    {
      ...
      originalReleaseDate: "19/05/2015",
      introduction:
    ...
    },
    {
      ...
      originalReleaseDate: "11/11/2011",
      introduction:
  ...
  Action_Adventure: [
    {
      ...
      originalReleaseDate: "13/04/1992",
      introduction:
    ...
    },
    {
      ...
      originalReleaseDate: "25/10/1996",
      introduction:
    ...
    },
    {
      ...
      originalReleaseDate: "23/08/2001",
      introduction:
    ...
    },
    {
      ...
      originalReleaseDate: "11/11/2003",
      introduction:
    ...
    },
    {
      ...
      originalReleaseDate: "28/10/2003",
      introduction:
    ...
    },
    {
      ...
      originalReleaseDate: "26/10/2004",
      introduction:
    ...
    },
    {
      ...
      originalReleaseDate: "25/08/2009",
      introduction:
    ...
    },
    {
      ...
      originalReleaseDate: "17/11/2009",
      introduction:
    ...
    },
    {
      ...
      originalReleaseDate: "17/09/2013",
      introduction:
    ...
    },
    {
      ...
      introduction:
        " The player controls Link, who awakens from a hundred-year slumber to defeat Calamity Ganon and save the kingdom of Hyrule. Similar to the original 1986 The Legend of Zelda game, players are given little instruction and can explore the open world freely. Tasks include collecting various items and gear to aid in objectives such as puzzle-solving or side quests. The world is unstructured and designed to encourage exploration and experimentation, and the main story quest can be completed in a nonlinear fashion.",
    },
  ],
  Adventure: [
    {
    ...
    },
    {
      ...
      originalReleaseDate: "27/06/2012",
      introduction:
  ...
  Fighting: [
    {
      ...
      originalReleaseDate: "08/10/1992",
      introduction:
  ...
  First_Person_Shooter: [
    ...
    },
    {
      ...
      originalReleaseDate: "15/11/2001",
      introduction:
  ...
  Platform: [
    ...
    },
    {
      ...
      originalReleaseDate: "02/12/2008",
      introduction:
  ...
  Puzzle_Platformer: [
    ...
    },
    {
      ...
      platforms: [
        ...
        "PlayStation Store (PSP/PS3/PSVita/AB Trilogy)",
        "Xbox 360 (AB Trilogy)",
        "Windows (discontinued since 2014)",
        "WebGL",
      ...
      originalReleaseDate: "11/12/2009",
      introduction:
    ...
    },
    {
      ...
      platforms: [
        ...
        "Mac OS X",
        "Linux",
        "Android (Nvidia Shield only)",
      ],
      originalReleaseDate: "10/10/2007",
      introduction:
  ...
  Sandbox: [
    {
      ...
      originalReleaseDate: "18/11/2011",
      introduction:
  ...
  Third_Person_Shooter: [
    {
      ...
      originalReleaseDate: "23/07/2001",
      introduction:
